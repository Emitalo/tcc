\chapter{API para módulos matemáticos plugáveis} \label{cap:proposta}
...
Necessidades do  ``Empurrando Juntos'':

\begin{itemize}
 \item Gerenciamento das conversas, comentários e votos;
 \item Agrupamento dos usuários a partir dos votos;
\end{itemize}

Considerando as necessidades do ``Empurrando Juntos'', foi estabelecida uma arquitetura de três módulos principais:
...
\section{Arquitetura da solução} \label{architecture}
    ...
    madura, estável, bem acolhida pela comunidade e ser de fácil integração com o projetos em Python.
