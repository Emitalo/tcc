\chapter{Definição e planejamento da proposta} \label{cap:proposta}
 ...
 definido em suas propostas iniciais (\citeonline{parra, tallys_tcc}) 
...
\section{Requisitos da solução} \label{requirements}
    ...
    A partir do escopo do ``Empurrando Juntos'' definido por \citeonline{empurrandojuntos}
...
\section{Planejamento do trabalho}
    ...
    \begin{itemize}
     ...
     adaptar aplicação desenvolvida por \citeonline{tallys_tcc};
