...
%     \pagebreak
	...
	\label{tab:tasks}
	  ...
	  \begin{tabular}[c]{@{}l@{}}Excluir comentário \\ (pentano.delete\_comment)\end{tabular}                   & Identificador do comentário              & Confirmação de Sucesso         \\ \midrule
	  \begin{tabular}[c]{@{}l@{}}Excluir voto\\ (pentano.delete\_vote)\end{tabular}                   & Identificador do voto & Confirmação de Sucesso         \\ \bottomrule
	\end{tabular}
	\end{table}
