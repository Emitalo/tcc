...
%     Colocar links para os repos
  ...
  \section{Módulo matemático}
    ...
    Os dois módulos apresentados neste capítulo complementaram do ponto de vista funcional a arquitetura definida para o ``Empurrando Juntos'' e permitiram 
    a visualização do funcionamento da API e do sistema por completo. 
    
%     Na Figura \ref{fig:aplicacao_cliente} é possível ver a tela da aplicação criada.