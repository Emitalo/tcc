...
usuário e a Internet, através de serviços web (\textit{web services}). Essa arquitetura permite que os componentes de 
...
% \citeonline{wagh2012comparative} afirma que as mensagens SOAP tem um conteúdo pesado e por
% esse motivo não sendo sendo indicadas para dispositivos móveis.

% PESQUISAR: Louridas, P. “SOAP and Web Services Software”, IEEE Volume: 23 ,
% Issue: 6 Digital Object Identifier: 10.1109/MS.2006.172 Publication
% Year: 2006 , Page(s): 62 - 67 Cited by: 2
