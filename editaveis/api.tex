...
A Transferência de Estado Representacional (do inglês, \textit{Representational State Transfer} ou REST)
  ...
  \section*{Elementos de dados}
    ...
    (documentos, imagens, serviços, entre outros). Para \citeonline{fielding2002}, um recurso é um mapeamento conceitual para um conjunto de entidades e não a entidade mapeada
    ...
    outros identificadores de recursos. A Tabela \ref{rest-data-elements} apresenta os elementos de dados no REST.
