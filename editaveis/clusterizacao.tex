...
Essa característica das estratégias não supervisionadas demonstra que este tipo de classificação é adequado para o contexto
do ``Empurrando Juntos'', no qual os grupos são formados com base em cada voto.

\section{Técnicas de classificação não supervisionada}




Dentre estas estratégias, existe a clusterização que é uma técnica já utilizada em ferramentas relacionadas
e por essa razão foi a técnica escolhida para o primeiro módulo matemático do ``Empurrando Juntos''. 
...
\subsection{Passos para a clusterização}
