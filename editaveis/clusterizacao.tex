\chapter{Classificação de Dados} \label{apd:classificacao}
...
com as categorias previamente definidas e conhecidas. \citeonline{han2011data} chamam esse tipo de dado de ``dado de treinamento''
...
Uma clusterização é hierárquica quando ela produz uma série
...
apenas o algoritmo k-Means, um algoritmo baseado no centro, que foi escolhido por \citeonline{tallys_tcc} 
...
\citeonline{tan2013data} e \citeonline{han2011data} resumiram o algoritmo da seguinte forma:
