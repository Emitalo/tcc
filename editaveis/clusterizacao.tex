...
Considerando todas os métodos e técnicas supracitados que são utilizados no Empurrando Juntos, a Figura \ref{fig:resumo_clusterizao_ej} apresenta um esquemático
