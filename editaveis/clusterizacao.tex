...
% nos quais os rótulos não necessitam ser definidos. Além da diversidade de métodos de classificação, 
% a própria clusterização pode ser implementada com o uso de 
