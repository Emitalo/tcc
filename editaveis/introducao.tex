...
Considerando as aplicações existentes, no contexto brasileiro, é perceptível que os sistemas estão voltados para informações, pedido de socorro e uma rede de desabafo e apoio entre as mulheres. Dessa forma, há uma lacuna em um apoio mais específico de acordo com a situação de violência, como sugestões de ações a serem tomadas e planejamento de segurança.
