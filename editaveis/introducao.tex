...
mas , para que os usuários façam parte deles. Essa característica determinou a implementação deste módulo da plataforma utilizando a técnica de clusterização.

Atualmente, o módulo que realiza a clusterização é a única funcionalidade em desenvolvimento na plataforma. Considerando a necessidade da plataforma 
...
Esse destaque é impulsionado pela nova geração, que busca defender o direito das mulheres, e 
pelas estatísticas obtidas. \citeonline{violence_global}, em sua pesquisa, mostra que 35\% das mulheres no mundo já vivenciaram 
uma situação de violência pelo física e/ou sexual pelo parceiro e violência sexual por outro indivíduo. No mundo, 38\% dos homicídios de mulheres são cometidos 
...
Cenários como esses impulsionaram, além das discussões promovidas nas redes sociais, a criação de políticas públicas (PP) para a redução da violência 
...
Nesse contexto, este trabalho, além desta introdução, está organizado em outros cinco capítulos. O Capítulo \ref{cap:clusterizacao} aborda os conceitos da 
técnica de classificação utilizada no ``Empurrando Juntos''. No Capítulo \ref{cap:api} são apresentados os conceitos e arquiteturas para APIs.
